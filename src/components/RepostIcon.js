...
export default function RepostIcon({ size = 24, color = "currentColor", className }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill={color} role="img" aria-label="Reposts" className={className}>
